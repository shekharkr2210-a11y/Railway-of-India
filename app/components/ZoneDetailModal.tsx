...
export const ZoneDetailModal: React.FC<ZoneDetailModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-white/80 backdrop-blur-md animate-fade-in">
      <div className="bg-gradient-to-b from-slate-900 via-slate-900 to-slate-950 border border-amber-500/40 rounded-3xl max-w-4xl w-full p-6 md:p-8 shadow-2xl relative overflow-hidden text-gray-900 max-h-[90vh] flex flex-col">
        {/* Glow Background */}
        ...
        <div className="overflow-y-auto pr-2 space-y-6 flex-1 relative z-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="p-4 rounded-2xl bg-white border border-gray-200">
              ...
              <p className="text-[10px] text-gray-400 mt-1">+3.2% vs manual baseline</p>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-white border border-gray-200">
              ...
              <p className="text-[10px] text-gray-400 mt-1">Multi-dept co-location rate</p>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-white border border-gray-200">
              ...
              <p className="text-[10px] text-gray-400 mt-1">{zone.divisionsCount} Divisions Integrated</p>
            </div>
          </div>
            ...
            {zoneDivisions.length > 0 ? (
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                {zoneDivisions.map(div => (
                  <div key={div.code} className="p-3 rounded-xl bg-gray-50 border border-gray-200 text-xs">
          ...
          <div className="bg-white p-5 rounded-2xl border border-gray-200">
            ...
            {zoneTasks.length > 0 ? (
              <div className="space-y-2">
                {zoneTasks.map(task => (
                  <div key={task.id} className="p-3 rounded-xl bg-gray-50 border border-gray-200 text-xs flex items-center justify-between">
                    <div>
                      <div className="flex items-center gap-2">
        ...
        <div className="mt-6 pt-4 border-t border-gray-200 flex flex-wrap items-center justify-between gap-3 relative z-10">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="px-4 py-2 rounded-xl text-xs font-bold bg-gray-100 hover:bg-gray-200 text-gray-800 border border-gray-300 transition-all flex items-center gap-1.5"
            >
